<template>
  <div>
    ...
    <h3 class="pt-0 mt-0 mb-1 text-sm tracking-tight border-none">
      Inheritance:
    </h3>
    <h3 class="pt-0 mt-0 mb-1 text-sm tracking-tight border-none">Function:</h3>
    <div
    ...
    <h3 class="pt-0 mt-0 mb-1 text-sm tracking-tight border-none">Object:</h3>
    <div
...
import { JSRefLabels, inheritanceData, groupData } from '../../kuma';
  ...
  computed: {
    ...
    navigationStructure() {
      ...
      source[objectName] = globalObjectsPages.filter(
        ({ path }) => path.indexOf(`/en-US/docs/${slug}/`) >= 0
      );
      result[objectName] = {
        title: objectName,
        methods: [],
