<template>
  <svg :width="getWidth" :height="getHeight" viewBox="0 0 264.58333 264.58334">
    <g transform="translate(0,-32.41665)">
      <g transform="matrix(2.4819787,0,0,2.4819787,-4114.7413,672.28013)">
        <path
          ...
          style="opacity: 1;vector-effect: none;fill: none;stroke-width: 2.99900007;stroke-linecap: round;stroke-linejoin: round;stroke-miterlimit: 4;stroke-dasharray: none;stroke-dashoffset: 0;stroke-opacity: 1;"
          stroke="currentColor"
        />
        <path
        ...
        <path
          ...
          style="opacity: 1;vector-effect: none;stroke-width: 11.33480358;stroke-linecap: round;stroke-linejoin: round;stroke-miterlimit: 4;stroke-dasharray: none;stroke-dashoffset: 0;stroke-opacity: 1;"
          stroke="currentColor"
          fill="currentColor"
        />
        <path
...
export default {
  ...
  computed: {
    ...
    getHeight() {
      return Math.ceil((this.getWidth / 264.58333) * 264.58333);
    },
  },
};
</script>
